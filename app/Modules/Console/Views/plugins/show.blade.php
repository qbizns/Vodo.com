...
@section('header-actions')
    <a href="{{ route('console.plugins.index') }}" class="btn btn-secondary">
    ...
    <div class="plugin-details-container">
        ...
        <div class="detail-card">
            ...
            <div class="detail-card-footer">
                @if($plugin->isActive())
                    <form action="{{ route('console.plugins.deactivate', $plugin->slug) }}" method="POST" class="inline-form">
                        @csrf
                ...
                @else
                    <form action="{{ route('console.plugins.activate', $plugin->slug) }}" method="POST" class="inline-form">
                        @csrf
                ...
                <form action="{{ route('console.plugins.destroy', $plugin->slug) }}" method="POST" class="inline-form"
