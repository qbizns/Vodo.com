...
class SettingsController extends Controller
{
    ...
    public function general(): View
    {
        ...
        return view('backend.settings.partials.general', [
            ...
            'values' => $values,
            'saveUrl' => route('console.settings.general.save'),
        ]);
    }
    ...
    public function saveGeneral(Request $request)
    {
        ...
        return redirect()->route('console.settings.index')
    ...
    public function plugin(string $slug): View
    {
        ...
        return view('backend.settings.partials.plugin', [
            ...
            'fields' => $fields,
            'values' => $values,
            'saveUrl' => route('console.settings.plugin.save', $slug),
        ]);
    }
    ...
    public function savePlugin(Request $request, string $slug)
    {
        ...
        return redirect()->route('console.settings.index', ['section' => 'plugin:' . $slug])
