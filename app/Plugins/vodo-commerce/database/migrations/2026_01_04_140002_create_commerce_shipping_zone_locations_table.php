...
return new class extends Migration
{
    ...
    {
        Schema::create('commerce_shipping_zone_locations', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('zone_id')->references('id')->on('commerce_shipping_zones')->onDelete('cascade');
            $table->index('zone_id');
    ...
    {
        Schema::dropIfExists('commerce_shipping_zone_locations');
    }
};
