...
@section('page-id', 'ums/users/create')
...
<div class="user-form-page">
    <form id="createUserForm" action="{{ route('plugins.ums.users.store') }}" method="POST">
        @csrf
...
document.getElementById('createUserForm').addEventListener('submit', function(e) {
    ...
    Vodo.api.post(this.action, data)
        ...
        .catch(error => {
            Vodo.notification.error(error.message || 'Failed to create user');
        });
});
</script>
